...
@export var min_distraction_interval: float = 1.0
# Maximum Time for Distraction to re-appear
@export var max_distraction_interval: float = 2.0
# Minimum Cool Down
@export var min_cooldown_time: float = 2.0
# Maximum Cool Down
...
func _on_distraction_timer_timeout():
	...
	emit_signal("distraction_started", name)
...
func clear_distraction():
	...
	emit_signal("distraction_cleared", name)
